...
[Search the existing issues](https://github.com/antonioconselheiro/time2blocks/search?type=Issues) before logging a new one.
 ...
 * Create a [fork](https://guides.github.com/activities/forking/) from our repository by [clicking here](https://github.com/antonioconselheiro/time2blocks/fork), do a `git clone` of your forked repository and run `devcontainer open .` in the application folder;
